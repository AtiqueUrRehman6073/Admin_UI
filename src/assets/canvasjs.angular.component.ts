...
class CanvasJSChart implements AfterViewInit, OnChanges, OnDestroy {
	...
	constructor() {
		...
		this.styles = this.styles ? this.styles : { width: "100%", position: "relative",color:"#fff",background:"#000" };
		this.styles.height = this.options.height ? this.options.height + "px" : "210px";
